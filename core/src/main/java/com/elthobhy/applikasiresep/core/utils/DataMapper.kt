...
object DataMapper {
    ...
    fun entityPopularToDomainPopular(input: List<EntityPopular>): List<DomainPopular> {
        val out = ArrayList<DomainPopular>()
        input.map {
            val list = DomainPopular(
    ...
    fun responPopularToEntityPopular(input: List<MealsItemPopular>): List<EntityPopular> {
        val out = ArrayList<EntityPopular>()
        input.map {
